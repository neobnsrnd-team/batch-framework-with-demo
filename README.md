...
### 배치 목록 조회 결과 (GET /api/batch/jobs)

> 조회 시점: 2026-03-19 17:38 KST | 인스턴스: WAS1

| 배치 ID | 배치명 | Cron 표현식 | 다음 실행 | 남은 시간 |
|---|---|---|---|---|
| BATCH_DAILY_REPORT | 일일 리포트 배치 | `0 0 1 * * *` | 2026-03-20 01:00 | 7시간 21분 후 |
| BATCH_DATA_SYNC | 데이터 동기화 배치 | `0 30 2 * * *` | 2026-03-20 02:30 | 8시간 51분 후 |
| BATCH_SLOW_PROCESS | 대용량 처리 배치 | `0 0 0 * * *` | 2026-03-20 00:00 | 6시간 21분 후 |

---

### 배치 수행 이력 (FWK_BATCH_HIS)

> 테스트 실행 시점: 2026-03-19 17:26 KST

| BATCH_APP_ID | BATCH_DATE | SEQ | RES_RT_CODE | RECORD | SUCCESS | FAIL | CALLER |
|---|---|---|---|---|---|---|---|
| BATCH_DAILY_REPORT | 20260321 | 1 | SUCCESS | 100 | 100 | 0 | 999999 (REST) |
| BATCH_INIT_FAIL | 20260321 | 1 | SUCCESS | 10 | 10 | 0 | 999999 (REST) |
| BATCH_SLOW_PROCESS | 20260321 | 1 | SUCCESS | 500 | 500 | 0 | 999999 (REST) |
| BATCH_DAILY_REPORT | 20260320 | 1 | SUCCESS | 100 | 100 | 0 | 999999 (REST) |
| BATCH_INIT_FAIL | 20260320 | 1 | SUCCESS | 10 | 10 | 0 | 999999 (REST) |
| BATCH_PARTIAL_FAIL | 20260320 | 1 | SUCCESS | 1000 | 951 | 49 | 999999 (REST) |

> **CALLER 컬럼 (LAST_UPDATE_USER_ID)**
> - `0` : 스케줄러 자동 실행
> - `999999` : REST API 수동 실행
